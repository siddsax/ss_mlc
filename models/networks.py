...
class Encoder(nn.Module):
    def __init__(self, params, sample_layer=GaussianSample):
        ...
        self.fc_2 = nn.Linear(params.h_dim, params.h_dim_2)
        # self.fc_3 = nn.Linear(params.h_dim_2, params.z_dim)
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.fc_1 = nn.Linear(inputDim, params.h_dim_2)
        self.fc_2 = nn.Linear(params.h_dim_2, params.h_dim)
        self.reconstruction = nn.Linear(params.h_dim, params.x_dim)
